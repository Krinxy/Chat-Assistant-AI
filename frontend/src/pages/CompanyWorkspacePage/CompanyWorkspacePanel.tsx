...
export function CompanyWorkspacePanel({ language, onOpenProfile, isSidebarOpen, onOpenSidebar }: CompanyWorkspacePanelProps) {
  ...
  const handleDocumentOpen = useCallback((companyId: string, documentId: string): void => {
    setOpenedDocumentByCompany((prev) => ({ ...prev, [companyId]: documentId }));
  }, []);
    ...
    if (activeTab === "documents") {
      return (
        <DocumentsTabContent
          ...
          uploadedDocumentsByCompany={uploadedDocumentsByCompany}
          dismissedDocumentsByCompany={dismissedDocumentsByCompany}
          openedDocumentByCompany={openedDocumentByCompany}
          onDocumentUpload={handleDocumentUpload}
          onDocumentOpen={handleDocumentOpen}
          onDocumentDownload={triggerDocumentDownload}
          onDocumentPrint={triggerDocumentPrint}
