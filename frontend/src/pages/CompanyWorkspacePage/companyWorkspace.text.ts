...
export const getCompanyWorkspaceText = (language: Language): CompanyWorkspaceText => {
  if (language === "de") {
    return {
      ...
      documentsHint: "Klick auf eine Datei, um die Vorschau direkt zu oeffnen.",
      previewTitle: "Datei-Vorschau",
      previewEmpty: "Waehle eine Datei per Klick aus, um sie hier zu oeffnen.",
      openPreviewHint: "Klicken zum Oeffnen",
      ...
      kpiFourHint: "Abdeckung ueber alle Produkt-Scopes",
      ...
      notesLinkedEventLabel: "Event anhaengen",
      notesEditHeader: "Notiz bearbeiten",
      notesEditSave: "Aenderungen speichern",
